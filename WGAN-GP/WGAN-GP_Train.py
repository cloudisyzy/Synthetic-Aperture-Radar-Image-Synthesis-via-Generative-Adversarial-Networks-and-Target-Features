...
from __models.WGANGP import Discriminator, Generator, gradient_penalty
sys.path.remove("..")
...
#             Train Generator and Discriminator Equally
    ...
    #         Train with fake data
            ...
            loss_D = -(d_loss_real - d_loss_fake) + hp_lambda_gp*GP
            loss_D.backward()
            solver_D.step()
    ...
    with open("WGAN_GP_SSIM_list.txt", "a") as file:
        file.write('\n')
        file.write('%s\n' %category_name)
